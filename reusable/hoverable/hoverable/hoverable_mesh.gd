...
@export var hover_mesh_scale : float = 1.0
@export var hover_mesh_scale_x : float = 0.1
@export var hover_mesh_y_translation : float = 0.0
...
func display_hover():
	...
	# breif exspand
	hover_mesh.scale.x += hover_mesh_scale
	hover_mesh.position.y += hover_mesh_y_translation #adjust for blender bottom origin
	hover_mesh.scale.z += hover_mesh_scale_x
