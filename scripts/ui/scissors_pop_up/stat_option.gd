...
func _process(_delta: float) -> void:
	if stat_hovered_over :
		if Input.is_action_just_pressed('attack') :
			...
			GLUsableItemBus.emit_signal('scissor_pop_up_chose_stat', stat_type, selected_cell, useable_item_obj )
			GLUsableItemBus.emit_signal('toggle_show_scissors_pop_up', false, null, null)
